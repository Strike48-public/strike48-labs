...
```tape
# Pick - Network Scan
# Demonstrates running a network scan with Pick

Output ../public/gifs/pick-network-scan.gif
...
Type "# Pick - Network Scan"
Sleep 1s
Enter
Enter

Type "pick scan --target 192.168.1.0/24 --ports 22,80,443"
Sleep 300ms
Enter
Sleep 1s
...
Type "pick results list"
Sleep 300ms
Enter
Sleep 500ms

Type "HOST              PORTS        STATUS      SCANNED"
Type "192.168.1.1       22,80        up          2026-03-04"
Sleep 2s
...
```tape
Type "pick results delete scan-123"
Sleep 300ms
Enter
Sleep 800ms
