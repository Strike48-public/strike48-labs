---
title: Configuration
description: Configure Dioxus Connector for your environment
---

# Configuration Guide

This guide covers how to configure the Dioxus Connector to connect to your Strike48 backend and customize its behavior.

## Overview

The Dioxus Connector requires configuration to connect to the Strike48 backend server. Configuration can be provided through:
