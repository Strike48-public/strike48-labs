...
|----------|-------------|---------|----------|
| `MATRIX_HOST` or `MATRIX_URL` | Matrix server URL | `localhost:50061` | Yes |
...
2. Admin approves connector in Matrix Studio
...
Instance metadata enables multi-instance routing and better UI display in Matrix Studio.
...
Matrix Studio uses instance metadata for intelligent routing:
...
|----------|------|---------|-------------|
| `MATRIX_HOST` | String | `localhost:50061` | Matrix server host:port |
