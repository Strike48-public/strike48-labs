...
Welcome to the **Strike48 SDK for Rust** documentation. This SDK enables you to build powerful, type-safe connectors that integrate seamlessly with the Matrix Connector Framework.
...
- **Dioxus Connector** - Build interactive web-based connectors
...
- **Matrix Connector Framework** server running (for testing)
