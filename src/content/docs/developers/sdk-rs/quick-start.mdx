...
```
INFO  Connecting to Matrix server at localhost:50061
...
Open Matrix Studio and approve the pending connector connection.

### Step 2: Send a Test Request

From Matrix Studio or using the Matrix API, send a test request:
...
**Solution:** Ensure the Matrix server is running at the configured host/port.
...
**Solution:**
1. Check that you've approved the connector in Matrix Studio
