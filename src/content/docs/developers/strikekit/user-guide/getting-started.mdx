...
description: "This guide will help you access and configure StrikeKit for your first red team engagement."
---
...
For a detailed walkthrough of the interface, see [Interface Overview](interface-overview).

## Recommended Workflow

See the [Workflow Guide](workflow) for the recommended approach to running engagements with StrikeKit.
...
1. **[Interface Overview](interface-overview)** - Learn the complete interface
2. **[Workflow Guide](workflow)** - Follow the recommended engagement workflow
3. **[Create Targets](../features/targets)** - Add systems to test
4. **[Set Up C2](../features/c2)** - Configure command and control
5. **[Document Findings](../features/findings)** - Record discovered vulnerabilities

## Request Access

StrikeKit requires an entitlement to use. If you'd like access, join our [Discord server](https://discord.gg/J3mukDFzfq) and let us know — we'll get you set up.

**Related Documentation:**
- [Quick Start Guide](quick-start) - Fastest way to get started
- [All Features](../#features) - Complete feature documentation
- [Assistant](../features/assistant) - Get AI-powered help
