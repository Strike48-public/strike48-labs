...
<InstallButton href="/kubestudio/guides/installation/" />

![KubeStudio](/img/kubestudio/screenshots/overview.png)
...
<video autoplay loop muted playsinline style="width:100%; margin-top:0.75rem; border-radius:0.75rem; box-shadow:0 2px 8px rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.10);">
  <source src="/img/kubestudio/videos/cluster-management.mp4" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline style="width:100%; margin-top:0.75rem; border-radius:0.75rem; box-shadow:0 2px 8px rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.10);">
  <source src="/img/kubestudio/videos/deployments.mp4" type="video/mp4" />
</video>
