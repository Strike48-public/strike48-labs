---
title: Architecture
description: Technical architecture of Dioxus Connector
---

# Architecture

This document provides an in-depth look at the Dioxus Connector's architecture, project structure, and design decisions.

## High-Level Architecture

The Dioxus Connector follows a modular, multi-platform architecture where each application variant (desktop, web, mobile, TUI) is a standalone connector that registers with Strike48 and executes tools locally.
