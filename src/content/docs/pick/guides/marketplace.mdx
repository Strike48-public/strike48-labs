...
All tools can be triggered remotely through the Prospector Studio API. When connected to a Prospector Studio backend (standalone or via StrikeHub), tools are registered and can be invoked by:
