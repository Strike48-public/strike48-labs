...
:::tip
Pick should automatically reconnect and re-register tools. If it doesn't, restart the Pick process.
:::
...
:::note
Timeouts are configured on the Studio side. If a tool legitimately needs more time, coordinate with your Studio administrator to adjust the invocation timeout.
:::
