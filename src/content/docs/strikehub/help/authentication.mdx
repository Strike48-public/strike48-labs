...
:::tip
Check your Keycloak admin console to verify the client's **Valid Redirect URIs** include `http://localhost:*`.
:::
...
:::caution
Never use `MATRIX_TLS_INSECURE=true` in production. It disables certificate validation entirely.
:::
