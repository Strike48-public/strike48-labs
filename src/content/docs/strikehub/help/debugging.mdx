...
:::tip
Strip any sensitive data (tokens, passwords, internal hostnames) from log files before sharing.
:::

:::note
For connector-specific logging, see the debug logging guides for [KubeStudio](/kubestudio/help/debugging/) and [Pick](/pick/help/debugging/).
:::
